 ...
 */
public class FasterAnimationContainer{
    ...
    private FasterAnimationContainer(ImageView imageView) {
        init(imageView);
    };

    // single instance procedures
    private static FasterAnimationContainer sInstance;

    public static FasterAnimationContainer getInstance(ImageView imageView) {
        if (sInstance == null)
            sInstance = new FasterAnimationContainer(imageView);
