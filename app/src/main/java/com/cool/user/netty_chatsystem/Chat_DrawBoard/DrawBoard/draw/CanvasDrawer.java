package com.cool.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.draw;

import android.graphics.Canvas;
import android.graphics.Paint;
import android.graphics.RectF;

import com.cool.user.netty_chatsystem.BuildConfig;
import com.cool.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.DrawableViewConfig;
import com.cool.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.draw.log.CanvasLogger;
import com.cool.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.draw.log.DebugCanvasLogger;
import com.cool.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.draw.log.NullCanvasLogger;
