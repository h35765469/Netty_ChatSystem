package com.cool.user.netty_chatsystem.Chat_Fragment.CameraFragment.internal.manager.impl;
...
public class Camera1Manager extends BaseCameraManager<Integer, SurfaceHolder.Callback> {
            ...
            backgroundHandler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        System.out.println("startCamera " + camera);
            ...
            backgroundHandler.post(new Runnable() {
                ...
                public void run() {
                    if (camera != null) {
                        camera.release();
                        camera = null;
                        System.out.println("stopCamera " + camera);
    ...
    public Size getPhotoSizeForQuality(@Configuration.MediaQuality int mediaQuality) {
        System.out.println("Camera1Manager camera " + camera );
        if(camera != null) {
