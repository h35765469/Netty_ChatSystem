package com.cool.user.netty_chatsystem.Chat_Fragment.CameraFragment.internal.controller.impl;
...
import com.cool.user.netty_chatsystem.Chat_Fragment.CameraFragment.internal.manager.impl.Camera1Manager;
...
import com.cool.user.netty_chatsystem.Chat_Fragment.CameraFragment.internal.ui.view.AutoFitSurfaceView;
...
public class Camera1Controller implements CameraController<Integer>,
    ...
    public void onCreate(Bundle savedInstanceState) {
        System.out.println("Controller onCreate");
    ...
    public void onResume() {
        System.out.println("Controller onResume");
        cameraManager.openCamera(currentCameraId, this);
    }

    @Override
    public void onPause() {
        System.out.println("Controller onPause");
    ...
    public void onDestroy() {
        System.out.println("Controller onDestroy");
