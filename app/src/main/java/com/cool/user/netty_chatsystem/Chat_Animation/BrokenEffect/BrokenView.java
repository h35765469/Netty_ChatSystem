package com.cool.user.netty_chatsystem.Chat_Animation.BrokenEffect;
...
public class BrokenView extends View {
    ...
    public void onBrokenCancelEnd(View v){
        if(callBack != null)
            callBack.onCancelEnd(v);
    }

    public void onBrokenFallingEnd(View v){
        if(callBack != null)
    ...
    public void onBrokenFalling(View v){
