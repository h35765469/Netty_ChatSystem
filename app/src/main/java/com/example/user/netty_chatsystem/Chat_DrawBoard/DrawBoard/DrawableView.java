package com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoard;
...
import com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.draw.CanvasDrawer;
import com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.draw.PathDrawer;
import com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.draw.SerializablePath;
import com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.gestures.creator.GestureCreator;
import com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.gestures.creator.GestureCreatorListener;
import com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.gestures.scale.GestureScaleListener;
import com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.gestures.scale.GestureScaler;
import com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.gestures.scale.ScalerListener;
import com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.gestures.scroller.GestureScrollListener;
import com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.gestures.scroller.GestureScroller;
import com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoard.gestures.scroller.ScrollerListener;
import com.example.user.netty_chatsystem.Chat_DrawBoard.DrawBoardFragement;
...
public class DrawableView extends View
  ...
  private DrawBoardFragement drawBoardFragement;
  ...
  public void setConfig(DrawableViewConfig config) {
    ...
    gestureCreator.setConfig(config);//1
