...
import com.example.user.netty_chatsystem.ChatListViewAdapter.RowItem;
...
import com.example.user.netty_chatsystem.Chat_Fragment.BaseFragment;
import com.example.user.netty_chatsystem.Chat_Fragment.ProfileFragment.AddFriendFragment.AddFriendFragment;
import com.example.user.netty_chatsystem.Chat_Fragment.ProfileFragment.CollectFragment.CollectFragment;
import com.example.user.netty_chatsystem.Chat_Fragment.ProfileFragment.MyContetnFragment.MyContentFragment;
import com.example.user.netty_chatsystem.Chat_Fragment.ProfileFragment.NewFriendFragment.NewFreindFragment;
import com.example.user.netty_chatsystem.Chat_Fragment.ProfileFragment.PersonalSettingFragment.PersonalSettingFragment;
import com.example.user.netty_chatsystem.Chat_Fragment.ProfileFragment.StickerFragment.StickerFragment;
import com.example.user.netty_chatsystem.Chat_Fragment.SendContentFragment.AndroidMultiPartEntity;
import com.example.user.netty_chatsystem.Chat_Fragment.WhiteBoardFragment.Chat_AnimationElement.BangEffect.SmallBang;
import com.example.user.netty_chatsystem.Chat_MySQL.Config;
...
public class Profile_Fragment extends BaseFragment {
    ...
    public View initView(LayoutInflater inflater){
        ...
        ImageView newFriendImg = (ImageView)view.findViewById(R.id.newFriendImg);
        ImageView personSettingImg = (ImageView)view.findViewById(R.id.personSettingImg);
        ImageView addFriendImg = (ImageView)view.findViewById(R.id.addFriendImg);
        ImageView collectImg = (ImageView)view.findViewById(R.id.collectImg);
        ImageView stickerImg = (ImageView)view.findViewById(R.id.stickerImg);
        ImageView myContentImg = (ImageView)view.findViewById(R.id.myWorldContentImg);
        ...
        if(bundle !=null){
            if(bundle.getInt("finishOpen") != 1) {
                ...
                NewFreindFragment newFreindFragment = new NewFreindFragment();
                newFreindFragment.setArguments(bundle);
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.replace(R.id.allContainer, newFreindFragment);
        ...
        effectProfile_imageview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.allContainer, new TakeProfileFragment());
                fragmentTransaction.commit();
        ...
        newFriendImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.replace(R.id.allContainer, new NewFreindFragment());
                fragmentTransaction.commit();
            }
        });

        personSettingImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.replace(R.id.allContainer, new PersonalSettingFragment());
                fragmentTransaction.commit();
            }
        });
        ...
        addFriendImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.replace(R.id.allContainer, new AddFriendFragment());
                fragmentTransaction.commit();
            }
        });
        ...
        collectImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.replace(R.id.allContainer, new CollectFragment());
                fragmentTransaction.commit();
            }
        });
        ...
        stickerImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.replace(R.id.allContainer, new StickerFragment());
                fragmentTransaction.commit();
            }
        });

        myContentImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.replace(R.id.allContainer, new MyContentFragment());
                fragmentTransaction.commit();
            }
        });
    ...
    private class DownloadImageTask extends AsyncTask<String, Void, Bitmap> {
        ...
        //當後台操作結束時，此方法將會被調用，計算結果將做為參數傳遞到此方法中，直接將結果顯示到UI組件上。
